...
import { coffeeHolic, CoffeeHolicStory, teaHolicStory, Story, StoryBlog } from '../../data';
    ...
    return (
        ...
        <div className="container container__storyhome">
            ...
            <ul className="story__home--menu">
                ...
                <li  className = 'story__home--memu active' ><NavLink className = '' to={'/pages/story/teaholic'}    >TeaHolic</NavLink></li>
        ...
        <div className="container container__storychild col-lg-12 col-md-12 col-sm-12 col-12">
            {
               story.map(({type_story, children}, index) => {
